...
10.times do |n|
  ...
  ProductVariation.create!(product_id: product.id, name: 'size', value: 'S', quantity: rand(10))
  ProductVariation.create!(product_id: product.id, name: 'size', value: 'L', quantity: rand(10))
